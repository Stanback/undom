		...
		var Element = (function (Node) {
			function Element(nodeType, nodeName) {
				...
				Object.defineProperty(this, 'innerHTML', {
					set: function (val) {
						while (this$1.firstChild) {
							this$1.removeChild(this$1.firstChild);
						}
						this$1._innerHTML = val;
					},
					get: function () { return this$1._innerHTML; }
				});
			}
			...
			Element.prototype.insertBefore = function insertBefore (child, ref) {
				Node.prototype.insertBefore.call(this, child, ref);
				if (this._innerHTML) {
					this._innerHTML = '';
				}
			};
